...
/*! \brief  Sets start OLED.
 *  reset global variables col and page. 
 *  Set start at this position.
 *
 *  \param void
 *
 *  \return void
...
void print_char(char input,FILE*stream){ // har blitt gjort VOID, var INT
		for (int i = 0; i < FONTSIZE; i++){
			OLED_write_data(pgm_read_byte(&font[(int)input-32][i]));
			col ++;
		}
 ...
 *  goes to position.
 *
 *  \param uint8_t page, desired column.
...
/*! \brief  print Brage.
 *  Prints picture of Brage on OLED.
 *
 *  \param void
 *
 *  \return void
...
/*! \brief  print Tobias.
 *  Prints picture of Tobias on OLED.
 *
 *  \param void
 *
 *  \return void
...
/*! \brief  print Henning.
 *  Prints picture of Henning on OLED.
 *
 *  \param void
 *
 *  \return void
...
/*! \brief  print pig.
 *  Prints picture of a pig on OLED.
 *
 *  \param void
 *
 *  \return void
